...
@section('content')
    ...
    <div>
        ...
        @endphp
        <x-antd-typography.paragraph data-toggle="tooltip" :copyable="['text' => $a]">Replace copy text.</x-antd-typography.paragraph>
    </div>
    ...
    <div>
        ...
        <x-antd-typography.paragraph mark :ellipsis="['rows' => 3, 'expandable' => true]">
